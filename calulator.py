...
def toll_fee_passage(date, vehicle):
    ...
    if hour == 6 and minute >= 0 and minute <= 29:
        ...
        return 13
    elif hour >= 8 and hour <= 14 and minute >= 29 and minute <= 59:
        return 8
...
def _is_toll_free_date(date):
    if date.weekday() in (5, 6):
        ...
        if (date.month == 1 and date.day == 1
                or date.month == 3 and (date.day == 29 or date.day == 29)
                or date.month == 4 and (date.day == 1 or date.day == 30)
                or date.month == 5 and (date.day == 1 or date.day == 8 or date.day == 9)
                or date.month == 6 and (date.day == 5 or date.day == 6 or date.day == 21)
                or date.month == 7
                or date.month == 11 and date.day == 1
